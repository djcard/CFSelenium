component {
	...
	public WebDriver function init(
		any driver=createObject( 'java', 'org.openqa.selenium.WebDriver' )
	) {
...
// if at this point, must have an array of web elements
	...
	private WebElement function findElementByAttributeValue( required string attribute
		,required string value
		,required array webElements
	) {
...
// authenticateAs(String username, String password, String host, int port, String clientHost, String domain)
	public void function authenticateAs( required string username
		...
		variables.driver.authenticateAs( arguments.username
			,arguments.password
			,arguments.host
			,arguments.port
			,arguments.clientHost
			,arguments.domain
		);
	}
...
//org.openqa.selenium.WebDriver$Options
	...
	private function getBy() {
		return createObject( 'java', 'org.openqa.selenium.By' );
	}
...
// get an arbitrary object from the wdm library
			...
			var webDriverManager = createObject( 'java', 'io.github.bonigarcia.wdm.WebDriverManager' );
// get its classloader
